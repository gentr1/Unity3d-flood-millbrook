Shader "Custom/StandardPBS_Phong_32bits_Depth" {
	Properties {
			...
			_ScaleDisplacement ("Displacement", Range(1.0, 10.0)) = 1.0
        ...
        SubShader {
            ...
            void disp (inout appdata v)
            {
				...
				float d = dot(float4 (myr,myg,myb,mya) ,UnpackFactors) * _Displacement*_ScaleDisplacement;
